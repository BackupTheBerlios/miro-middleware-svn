...
// 
//////////////////////////////////////////////////////////////////////////////
#ifndef SparrowAlive_h
#define SparrowAlive_h

#include "miro/StructuredPushConsumer.h"

#include <string>

class SparrowAlive : public Miro::StructuredPushConsumer
{
...
public:
   ...
   */
  SparrowAlive(CosNotifyChannelAdmin::EventChannel_ptr _ec,
	      const std::string& domainName);

  /** Disconnect from the supplier. */
  virtual ~SparrowAlive();

...
LaserAvoidParameters::LaserAvoidParameters() :
  minDistance(500),
  haltDistance(300),
  leftLaser(270),
  rightLaser(90),
...
void
LaserAvoidParameters::operator <<= (const KeyValueList& _params)
{
...
void
LaserAvoidParameters::printToStream(std::ostream& ostr) const
{

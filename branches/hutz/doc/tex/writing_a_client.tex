...
\lstinputlisting[frame=tb, caption={examples/sonar/sonarPoll1.cc\label{lst:SonarPoll1}}]{sonarPoll1.cc}

A step by step walk trough the code:

\lstinputlisting[frame=tb, first=1, last=1]{sonarPoll1.cc}

The file \lstinline!miro/client.hh! contains the definition of the class
\lstinline!Miro::Client!. See below.

\lstinputlisting[frame=tb, first=2, last=2]{sonarPoll1.cc}

The file \lstinline!miro/rangeSensorC.hh! provides the classes for the interface of the
...
\lstinputlisting[frame=tb, first=6, last=6]{sonarPoll1.cc}

A standard main function is used.

\lstinputlisting[frame=tb, first=8, last=8]{sonarPoll1.cc}
...
\lstinputlisting[frame=tb, first=9, last=10]{sonarPoll1.cc}
...
\lstinputlisting[frame=tb, first=11, last=11]{sonarPoll1.cc}
...
\lstinputlisting[frame=tb, first=13, last=13]{sonarPoll1.cc}

This gets a sonar scan from the service. Note, that we do not see where 
the service runs.

\lstinputlisting[frame=tb, first=15, last=20]{sonarPoll1.cc}

These line are used to print the received sonar scan to the console.

%\lstinputlisting[frame=tb, first=22, last=22]{sonarPoll1.cc}
...
\lstinputlisting[frame=tb, first=6, last=9]{sonarPoll2.cc}
...
\lstinputlisting[frame=tb, first=6, caption={examples/sonar/sonarPoll2.cc\label{lst:SonarPoll2}}]{sonarPoll2.cc}
...
\lstinputlisting[frame=tb, first=14, caption={examples/sonar/sonarPoll3.cc\label{lst:SonarPoll3}}]{sonarPoll3.cc}
...
\lstinputlisting[frame=tb, first=24, last=53, caption={examples/sonar/sonarNotify.cc\label{lst:SonarNotify}}]{sonarNotify.cc}

A step by step walk trough the code:

\lstinputlisting[frame=tb, first=24, last=24]{sonarNotify.cc}
...
\lstinputlisting[frame=tb, first=31, last=31]{sonarNotify.cc}
...
\lstinputlisting[frame=tb, first=33, last=35]{sonarNotify.cc}
...
\lstinputlisting[frame=tb, first=37, last=37]{sonarNotify.cc}

Tell the consumer admin what we want to subscribe for.

\lstinputlisting[frame=tb, first=48, last=49]{sonarNotify.cc}
...
\lstinputlisting[frame=tb, first=54, caption={examples/sonar/sonarNotify.cc\label{lst:SonarNotify2}}]{sonarNotify.cc}

Lets now have a look at the \lstinline!main! function:

\lstinputlisting[frame=tb, first=57, last=57]{sonarNotify.cc}
...
\lstinputlisting[frame=tb, first=59, last=59]{sonarNotify.cc}
...
\lstinputlisting[frame=tb, first=61, last=61]{sonarNotify.cc}

Instanciate the push consumer. It does all the necessary
initialization within its constructor.

\lstinputlisting[frame=tb, first=63, last=63]{sonarNotify.cc}

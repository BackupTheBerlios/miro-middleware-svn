...
// $Id$
//
#ifndef CompassStream_h
#define CompassStream_h

#include "miro/StructuredPushConsumer.h"

#include <string>

class CompassStream : public Miro::StructuredPushConsumer
{
...
public:
   ...
   */
  CompassStream(CosNotifyChannelAdmin::EventChannel_ptr _ec,
	     const std::string& domainName);
  /** Disconnect from the supplier. */
  virtual ~CompassStream();

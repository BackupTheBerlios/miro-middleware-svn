...
\item Behaviour Descriptions \\
  ...
  the load was successful is currently only done on leaving the
  dialog. On the
...
\item Rename transition \\
  ...
  or the target of the transition. - Be carful, the new entry
...
\item Set parameters \\
  ...
  typed. Therefore the okay button inactive if any of the entry fields

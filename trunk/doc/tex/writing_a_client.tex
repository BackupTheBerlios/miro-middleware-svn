...
\lstinputlisting[frame=tb, caption={examples/sonar/SonarPoll1.cpp\label{lst:SonarPoll1}}]{SonarPoll1.cpp}
...
\lstinputlisting[frame=tb, first=6, caption={examples/sonar/SonarPoll2.cpp\label{lst:SonarPoll2}}]{SonarPoll2.cpp}
...
\lstinputlisting[frame=tb, first=14, caption={examples/sonar/SonarPoll3.cpp\label{lst:SonarPoll3}}]{SonarPoll3.cpp}
...
\lstinputlisting[frame=tb, first=24, last=53, caption={examples/sonar/SonarNotify.cpp\label{lst:SonarNotify}}]{SonarNotify.cpp}
...
\lstinputlisting[frame=tb, first=54, caption={examples/sonar/SonarNotify.cpp\label{lst:SonarNotify2}}]{SonarNotify.cpp}

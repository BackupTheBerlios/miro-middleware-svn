...
\lstinputlisting[frame=tb, firstline=24, lastline=53, caption={examples/sonar/SonarNotify.cpp}]{SonarNotify.cpp}
\label{lst:SonarNotify}

A step by step walk trough the code:

\lstinputlisting[frame=tb, firstline=24, lastline=24]{SonarNotify.cpp}
...
\lstinputlisting[frame=tb, firstline=31, lastline=31]{SonarNotify.cpp}
...
\lstinputlisting[frame=tb, firstline=33, lastline=35]{SonarNotify.cpp}
...
\lstinputlisting[frame=tb, firstline=37, lastline=37]{SonarNotify.cpp}

Tell the consumer admin what we want to subscribe for.

\lstinputlisting[frame=tb, firstline=48, lastline=49]{SonarNotify.cpp}
...
\lstinputlisting[frame=tb, firstline=54, caption={examples/sonar/SonarNotify.cpp}]{SonarNotify.cpp}
...
\lstinputlisting[frame=tb, firstline=59, lastline=59]{SonarNotify.cpp}
...
\lstinputlisting[frame=tb, firstline=61, lastline=61]{SonarNotify.cpp}

Instanciate the push consumer. It does all the necessary
initialization within its constructor.

\lstinputlisting[frame=tb, firstline=63, lastline=63]{SonarNotify.cpp}

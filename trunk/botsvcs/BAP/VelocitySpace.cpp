...
namespace Miro
{
  namespace BAP
  {
	...
	temp_x = (i->real() - _point.real()) * cosAngle + 
	  (i->imag() - _point.imag()) * -sinAngle;
	temp_y = (i->real() - _point.real()) * sinAngle + 
	  (i->imag() - _point.imag()) * cosAngle;
	...
	*i += _distance;
    ...
    //
    void 
    VelocitySpace::rotatePolygon(Polygon &_polygon, 
				 Vector2d const&_point, double _angle) 
    {
      Polygon::iterator i;
	...
	*i += _distance;
    ...
    void 
    VelocitySpace::addPositiveCurvatureConstraint(double _constrB, 
						  double _constrE)
    {
    ...
    void 
    VelocitySpace::addNegativeCurvatureConstraint(double _constrB, 
						  double _constrE)
    {
